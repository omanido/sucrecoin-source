...
unsigned int nTargetSpacing = 600; // 10 minutes
unsigned int nStakeMinAge = 24 * 60 * 60; // 24 hours
unsigned int nStakeMaxAge = 30 * 24 * 60; // 30 days
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1512082324, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        block.nVersion = 1;
        block.nTime    = 1512082324;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 618677 : 618677;
        ...
        assert(block.hashMerkleRoot == uint256("0x71c7b448ba8e9ffb7e0f59a07c43d038b26aafb67e82368cef0360bfb67f59c0"));
...
unsigned char pchMessageStart[4] = { 0xe7, 0x58, 0xb1, 0x7b };
